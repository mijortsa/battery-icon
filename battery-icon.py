...
#  Thanks to Thomas Krug all about
# ======================================================================= 
#  Modification :
...
class TrayIcon():
    ...
    def __init__(self):
        ...
        self.iconpath = "/usr/share/battery-icon/icons/"
        self.iconname = "/usr/share/battery-icon/battery.svg"
    ...
    def get_menu(self):
        ...
        setting = Gtk.MenuItem("Power Setting")
        setting.connect("activate", self.show_setting_dialog)
    ...
    def show_setting_dialog(self, widget = None, data = None):
    ...
    def show_about_dialog(self, widget):
        ...
        about_dialog.set_program_name("Battery Icon")
        about_dialog.set_version("Version 0.1")
        about_dialog.set_comments("A simple yet powerful tray icon, using: " + ctrl.name)
        about_dialog.set_copyright("Copyright © 2013")
        about_dialog.set_website("https://github.com/mijortsa/battery-icon")
        about_dialog.set_website_label("github.com/mijortsa/battery-icon")
        about_dialog.set_icon_from_file(self.iconname)

        about_dialog.set_logo(GdkPixbuf.Pixbuf.new_from_file_at_size(self.iconname, 96, 96))
